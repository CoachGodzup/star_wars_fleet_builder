...
export const DetailForm: React.FC = () => {
    ...
    const isValid = Boolean(detailStore.name && detailStore.description && detailStore.commander);
    ...
    return (
        <Container miw={400}>
            <form onSubmit={handleSubmit}>
                ...
                <NavButtons next={{url: '/composition', type: 'submit', isValid, invalidMessage: 'Please fill all the fields'}} />
            </form>
        </Container>
    );
}
